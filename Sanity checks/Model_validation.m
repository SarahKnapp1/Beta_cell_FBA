...
%% Note: the model needs to contain the insulin reaction for the protein turnover task
...
%%
% Model validation through metabolic tasks and consistency checks.

% provide path to thermodynamic data (including the file name)
Thermo_data_PATH='C:/Users/sarah/matTFA-master/thermoDatabases/DB_AlbertyUpdate.mat';

% Load the thermodynamic database used
load(Thermo_data_PATH)

%provide path to matTFA
TFA_PATH= 'C:/Users/sarah/matTFA-master' ;

 % provide path to CPLEX 
CPLEX_PATH='C:/Program Files/IBM/ILOG/CPLEX_Enterprise_Server1210/CPLEX_Studio/cplex/matlab/x64_win64';        
...
%% Protein turnover
%Task35: Protein synthesis from AAs %Insulin

task_name = 'Protein synthesis from AAs';
task_should_fail = 0;
task_mets_in = {'o2_e';'glc_e';'nh4_e';'h2o_e';'his_L_e';'lys_L_e';'met_L_e';'phe_L_e';'trp_L_e';'thr_L_e';'ile_L_e';'leu_L_e';'val_L_e'};

task_mets_in_lb = [NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;];
task_mets_in_ub = [NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;];
task_mets_out = {'INS_pro_c';'co2_e';'h2o_e'};
task_mets_out_lb = [NaN;NaN;NaN;NaN];
task_mets_out_ub = [NaN;NaN;NaN;NaN];
task_rxns = {'4 ala_L_c  +  4 arg_L_c + 3 asn_L_c  + 1 asp_L_c + 6 cys_L_c + 7 gln_L_c + 8 glu_L_c + 11 gly_c + 2 his_L_c + 2 ile_L_c + 12 leu_L_c + 2 lys_L_c + 3 phe_L_c + 3 pro_L_c + 5 ser_L_c + 3 thr_L_c + 4 tyr_L_c + 6 val_L_c + 370.316 atp_c + 370.316 h2o_c <=> 370.316 adp_c + 370.316 pi_c + 6 h_c + 85 h2o_c + INS_pro_c'};
task_rxns_lb = 0;
