...
paramHuman = struct (...%model parameters
                        ...
                        'GEMname',                            'Recon2_redHUMAN_fix'    ,... % name of the GEM used (as it is saved in GEMs folder)%'recon2_redHUMAN_curated'
                        'RedModelName',                       'redHUMAN_recon2'                      ,... % choose a name for the reduction
                        'SelectedSubsystems',                 {{'Glycolysis/gluconeogenesis';
                                                                ...
                                                                'Lysine metabolism';                                                              
                                                                'Urea cycle';
                                                                'Nitrogen metabolism'}}                       ,... % default (default is defined in the organism&GEM case-file), customly defined in a cell e.g. {{'x';'y';'z'}}
                        ...
                        ....%paths to folders
                        'CPLEX_PATH',                         'C:/Program Files/IBM/ILOG/CPLEX_Enterprise_Server1210/CPLEX_Studio/cplex/matlab/x64_win64'             ,... % 'PATH/TO/CPLEX'  provide path to CPLEX         
                        'TFA_PATH',                           'C:/Users/sarah/matTFA-master'                      ,... % PATH/TO/matTFA' provide path to matTFA
                        'thermo_data_PATH',                   'C:/Users/sarah/matTFA-master/thermoDatabases/DB_AlbertyUpdate.mat'   ,... % provide path to thermodynamic data (including the file name)
